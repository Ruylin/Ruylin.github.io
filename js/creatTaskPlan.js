jeDate("#dateChose", {
    theme: { bgcolor: "#337AB7", pnColor: "#286090" },
    format: "YYYY-MM-DD hh:mm:ss",
    multiPane: false,
    range: " 至 "
});
$('#createTaskPlan').click(function () {
    $('#createTaskPlanModal').modal("show");
});
function getTownInfo1() {
    axios({
        ...
        .then(function (res) {
            ...
            setTownInfo1(res.data.data.list);
        })
}
function setTownInfo1(AllList) {
    var pe = document.getElementById('level-4-1');
    var so = document.getElementById('level-5-1');
